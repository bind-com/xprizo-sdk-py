...
SchemaFor200ResponseBodyTextPlain = CategoryModel
SchemaFor200ResponseBodyApplicationJson = CategoryModel
SchemaFor200ResponseBodyTextJson = CategoryModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_category_get_model_get_oapg(
        self,
...
class ApiCategoryGetModelGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_category_get_model_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_category_get_model_get(
        ...
        return self._api_category_get_model_get_oapg(
