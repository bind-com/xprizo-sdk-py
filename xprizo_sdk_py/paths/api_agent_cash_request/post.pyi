...
# body param
SchemaForRequestBodyApplicationJson = AgentBankWithdrawalTransactionModel
SchemaForRequestBodyTextJson = AgentBankWithdrawalTransactionModel
SchemaForRequestBodyApplicationJson = AgentBankWithdrawalTransactionModel


request_body_agent_bank_withdrawal_transaction_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_agent_cash_request_post_oapg(
        self,
    ...
    def _api_agent_cash_request_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_agent_bank_withdrawal_transaction_model.serialize(body, content_type)
...
class ApiAgentCashRequestPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_agent_cash_request_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_agent_cash_request_post(
        ...
        return self._api_agent_cash_request_post_oapg(
            body=body,
