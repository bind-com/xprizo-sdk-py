...
# Query params
ActionSchema = AddTransactionAction
PinSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'action': typing.Union[ActionSchema, ],
        'pin': typing.Union[PinSchema, str, ],
    },
    total=False
)
...
# body param
SchemaForRequestBodyApplicationJson = UserSendPaymentTransactionModel
SchemaForRequestBodyTextJson = UserSendPaymentTransactionModel
SchemaForRequestBodyApplicationJson = UserSendPaymentTransactionModel


request_body_user_send_payment_transaction_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_transaction_send_payment_post_oapg(
        self,
    ...
    def _api_transaction_send_payment_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_user_send_payment_transaction_model.serialize(body, content_type)
...
class ApiTransactionSendPaymentPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_transaction_send_payment_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def api_transaction_send_payment_post(
        ...
        return self._api_transaction_send_payment_post_oapg(
            body=body,
