...
# Query params
ContactSchema = schemas.StrSchema
MerchantCodeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'contact': typing.Union[ContactSchema, str, ],
        'merchantCode': typing.Union[MerchantCodeSchema, str, ],
    },
    total=False
)
...
request_query_contact = api_client.QueryParameter(
    name="contact",
    style=api_client.ParameterStyle.FORM,
    schema=ContactSchema,
    explode=True,
)
request_query_merchant_code = api_client.QueryParameter(
    name="merchantCode",
    style=api_client.ParameterStyle.FORM,
    schema=MerchantCodeSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_wallet_info_list_get_oapg(
        self,
    ...
    def _api_wallet_info_list_get_oapg(
        ...
        for parameter in (
            request_query_contact,
            request_query_merchant_code,
        ):
...
class ApiWalletInfoListGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_wallet_info_list_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_wallet_info_list_get(
        ...
        return self._api_wallet_info_list_get_oapg(
