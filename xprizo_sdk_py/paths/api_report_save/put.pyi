...
# body param
SchemaForRequestBodyApplicationJson = ReportModel
SchemaForRequestBodyTextJson = ReportModel
SchemaForRequestBodyApplicationJson = ReportModel


request_body_report_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _api_report_save_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_report_model.serialize(body, content_type)
...
class ApiReportSavePut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_report_save_put(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_report_save_put(
        ...
        return self._api_report_save_put_oapg(
            body=body,
