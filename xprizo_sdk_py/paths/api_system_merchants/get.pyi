...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MerchantListModel']:
            return MerchantListModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['MerchantListModel'], typing.List['MerchantListModel']],
    ...
    def __getitem__(self, i: int) -> 'MerchantListModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_system_merchants_get_oapg(
        self,
...
class ApiSystemMerchantsGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_system_merchants_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_system_merchants_get(
        ...
        return self._api_system_merchants_get_oapg(
