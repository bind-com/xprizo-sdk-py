...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_category_set_data_hash_id_put_oapg(
        self,
...
class ApiCategorySetDataHashIdPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_category_set_data_hash_id_put(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, str, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def api_category_set_data_hash_id_put(
        ...
        return self._api_category_set_data_hash_id_put_oapg(
            body=body,
