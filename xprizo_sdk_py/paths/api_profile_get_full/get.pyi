...
SchemaFor200ResponseBodyTextPlain = ProfileFullModel
SchemaFor200ResponseBodyApplicationJson = ProfileFullModel
SchemaFor200ResponseBodyTextJson = ProfileFullModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_profile_get_full_get_oapg(
        self,
...
class ApiProfileGetFullGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_profile_get_full_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_profile_get_full_get(
        ...
        return self._api_profile_get_full_get_oapg(
