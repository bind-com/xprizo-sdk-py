...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CategoryModel']:
            return CategoryModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CategoryModel'], typing.List['CategoryModel']],
    ...
    def __getitem__(self, i: int) -> 'CategoryModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_category_list_all_get_oapg(
        self,
...
class ApiCategoryListAllGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_category_list_all_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_category_list_all_get(
        ...
        return self._api_category_list_all_get_oapg(
