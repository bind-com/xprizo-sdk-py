...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ItemListModel']:
            return ItemListModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ItemListModel'], typing.List['ItemListModel']],
    ...
    def __getitem__(self, i: int) -> 'ItemListModel':
...
class ApiItemListGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_item_list_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_item_list_get(
        ...
        return self._api_item_list_get_oapg(
