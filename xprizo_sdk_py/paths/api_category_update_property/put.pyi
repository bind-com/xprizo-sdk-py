...
# body param
SchemaForRequestBodyApplicationJson = CategoryPropertyModel
SchemaForRequestBodyTextJson = CategoryPropertyModel
SchemaForRequestBodyApplicationJson = CategoryPropertyModel


request_body_category_property_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_category_update_property_put_oapg(
        self,
    ...
    def _api_category_update_property_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_category_property_model.serialize(body, content_type)
...
class ApiCategoryUpdatePropertyPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_category_update_property_put(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_category_update_property_put(
        ...
        return self._api_category_update_property_put_oapg(
            body=body,
