...
NewPasswordSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'newPassword': typing.Union[NewPasswordSchema, str, ],
    },
    total=False
)
...
request_query_new_password = api_client.QueryParameter(
    name="newPassword",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_security_reset_password_put_oapg(
        self,
...
class ApiSecurityResetPasswordPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_security_reset_password_put(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_security_reset_password_put(
        ...
        return self._api_security_reset_password_put_oapg(
