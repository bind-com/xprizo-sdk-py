# xprizo_sdk_py.model.agent_bank_withdrawal_transaction_model.AgentBankWithdrawalTransactionModel
...
**bankId** | decimal.Decimal, int,  | decimal.Decimal,  |  | [optional] value must be a 64 bit integer
