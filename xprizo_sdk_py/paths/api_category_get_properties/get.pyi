...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CategoryPropertyModel']:
            return CategoryPropertyModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CategoryPropertyModel'], typing.List['CategoryPropertyModel']],
    ...
    def __getitem__(self, i: int) -> 'CategoryPropertyModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_category_get_properties_get_oapg(
        self,
...
class ApiCategoryGetPropertiesGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_category_get_properties_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_category_get_properties_get(
        ...
        return self._api_category_get_properties_get_oapg(
