...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_category_delete_property_hash_id_delete_oapg(
        self,
...
class ApiCategoryDeletePropertyHashIdDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_category_delete_property_hash_id_delete(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_category_delete_property_hash_id_delete(
        ...
        return self._api_category_delete_property_hash_id_delete_oapg(
