...
SchemaFor200ResponseBodyTextPlain = ProfileModel
SchemaFor200ResponseBodyApplicationJson = ProfileModel
SchemaFor200ResponseBodyTextJson = ProfileModel
...
class ApiProfileGetGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_profile_get_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_profile_get_get(
        ...
        return self._api_profile_get_get_oapg(
