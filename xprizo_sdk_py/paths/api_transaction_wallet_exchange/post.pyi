...
# Query params
CommitSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'commit': typing.Union[CommitSchema, bool, ],
    },
    total=False
)
...
request_query_commit = api_client.QueryParameter(
    name="commit",
...
# body param
SchemaForRequestBodyApplicationJson = UserWalletTransferTransactionModel
SchemaForRequestBodyTextJson = UserWalletTransferTransactionModel
SchemaForRequestBodyApplicationJson = UserWalletTransferTransactionModel


request_body_user_wallet_transfer_transaction_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_transaction_wallet_exchange_post_oapg(
        self,
    ...
    def _api_transaction_wallet_exchange_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_user_wallet_transfer_transaction_model.serialize(body, content_type)
...
class ApiTransactionWalletExchangePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_transaction_wallet_exchange_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def api_transaction_wallet_exchange_post(
        ...
        return self._api_transaction_wallet_exchange_post_oapg(
            body=body,
