...
SchemaFor200ResponseBodyTextPlain = TaskNoteModel
SchemaFor200ResponseBodyApplicationJson = TaskNoteModel
SchemaFor200ResponseBodyTextJson = TaskNoteModel
...
class ApiTaskGetIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_task_get_id_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_task_get_id_get(
        ...
        return self._api_task_get_id_get_oapg(
