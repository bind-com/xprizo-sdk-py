...
NationalNumberSchema = schemas.StrSchema
CaptachaSchema = schemas.StrSchema
IsNewSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'nationalNumber': typing.Union[NationalNumberSchema, str, ],
        'captacha': typing.Union[CaptachaSchema, str, ],
        'isNew': typing.Union[IsNewSchema, bool, ],
    },
    total=False
)
...
request_query_national_number = api_client.QueryParameter(
    name="nationalNumber",
    style=api_client.ParameterStyle.FORM,
    schema=NationalNumberSchema,
    explode=True,
)
request_query_captacha = api_client.QueryParameter(
    name="captacha",
    style=api_client.ParameterStyle.FORM,
    schema=CaptachaSchema,
    explode=True,
)
request_query_is_new = api_client.QueryParameter(
    name="isNew",
    style=api_client.ParameterStyle.FORM,
    schema=IsNewSchema,
    explode=True,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_security_send_otp_to_sms_get_oapg(
        self,
    ...
    def _api_security_send_otp_to_sms_get_oapg(
        ...
        for parameter in (
            ...
            request_query_national_number,
            request_query_captacha,
            request_query_is_new,
        ):
...
class ApiSecuritySendOtpToSmsGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_security_send_otp_to_sms_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_security_send_otp_to_sms_get(
        ...
        return self._api_security_send_otp_to_sms_get_oapg(
