...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DocumentTypeModel']:
            return DocumentTypeModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['DocumentTypeModel'], typing.List['DocumentTypeModel']],
    ...
    def __getitem__(self, i: int) -> 'DocumentTypeModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_document_types_get_oapg(
        self,
...
class ApiDocumentTypesGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_document_types_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_document_types_get(
        ...
        return self._api_document_types_get_oapg(
