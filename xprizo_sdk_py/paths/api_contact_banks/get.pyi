...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LedgerBankingModel']:
            return LedgerBankingModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['LedgerBankingModel'], typing.List['LedgerBankingModel']],
    ...
    def __getitem__(self, i: int) -> 'LedgerBankingModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_contact_banks_get_oapg(
        self,
...
class ApiContactBanksGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_contact_banks_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_contact_banks_get(
        ...
        return self._api_contact_banks_get_oapg(
