...
# body param
SchemaForRequestBodyApplicationJson = ItemListModel
SchemaForRequestBodyTextJson = ItemListModel
SchemaForRequestBodyApplicationJson = ItemListModel


request_body_item_list_model = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = ItemListModel
SchemaFor200ResponseBodyApplicationJson = ItemListModel
SchemaFor200ResponseBodyTextJson = ItemListModel
...
class BaseApi(api_client.Api):
    ...
    def _api_item_add_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_item_list_model.serialize(body, content_type)
...
class ApiItemAddPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_item_add_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_item_add_post(
        ...
        return self._api_item_add_post_oapg(
            body=body,
