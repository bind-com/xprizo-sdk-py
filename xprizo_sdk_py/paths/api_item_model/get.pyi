...
SchemaFor200ResponseBodyTextPlain = ItemDetailModel
SchemaFor200ResponseBodyApplicationJson = ItemDetailModel
SchemaFor200ResponseBodyTextJson = ItemDetailModel
...
class ApiItemModelGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_item_model_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_item_model_get(
        ...
        return self._api_item_model_get_oapg(
