...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_transaction_approval_cancel_get_oapg(
        self,
...
class ApiTransactionApprovalCancelGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_transaction_approval_cancel_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_transaction_approval_cancel_get(
        ...
        return self._api_transaction_approval_cancel_get_oapg(
