...
# Query params
PictureURLSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'pictureURL': typing.Union[PictureURLSchema, str, ],
    },
    total=False
)
...
request_query_picture_url = api_client.QueryParameter(
    name="pictureURL",
    style=api_client.ParameterStyle.FORM,
    schema=PictureURLSchema,
    explode=True,
)
# body param
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_preference_set_profile_picture_put_oapg(
        self,
...
class ApiPreferenceSetProfilePicturePut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_preference_set_profile_picture_put(
        self,
        content_type: typing_extensions.Literal["multipart/form-data"] = ...,
        body: typing.Union[SchemaForRequestBodyMultipartFormData, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def api_preference_set_profile_picture_put(
        ...
        return self._api_preference_set_profile_picture_put_oapg(
            body=body,
