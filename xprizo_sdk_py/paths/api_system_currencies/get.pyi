...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CurrencyItemModel']:
            return CurrencyItemModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CurrencyItemModel'], typing.List['CurrencyItemModel']],
    ...
    def __getitem__(self, i: int) -> 'CurrencyItemModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_system_currencies_get_oapg(
        self,
...
class ApiSystemCurrenciesGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_system_currencies_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_system_currencies_get(
        ...
        return self._api_system_currencies_get_oapg(
