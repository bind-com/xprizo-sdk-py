...
# body param
SchemaForRequestBodyApplicationJson = UserInstantPaymentTransactionModel
SchemaForRequestBodyTextJson = UserInstantPaymentTransactionModel
SchemaForRequestBodyApplicationJson = UserInstantPaymentTransactionModel


request_body_user_instant_payment_transaction_model = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = StringKeyPairModel
SchemaFor200ResponseBodyApplicationJson = StringKeyPairModel
SchemaFor200ResponseBodyTextJson = StringKeyPairModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_transaction_instant_payment_qr_code_post_oapg(
        self,
    ...
    def _api_transaction_instant_payment_qr_code_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_user_instant_payment_transaction_model.serialize(body, content_type)
...
class ApiTransactionInstantPaymentQrCodePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_transaction_instant_payment_qr_code_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_transaction_instant_payment_qr_code_post(
        ...
        return self._api_transaction_instant_payment_qr_code_post_oapg(
            body=body,
