...
SchemaFor200ResponseBodyTextPlain = SystemModel
SchemaFor200ResponseBodyApplicationJson = SystemModel
SchemaFor200ResponseBodyTextJson = SystemModel
...
class ApiSystemInfoGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_system_info_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_system_info_get(
        ...
        return self._api_system_info_get_oapg(
