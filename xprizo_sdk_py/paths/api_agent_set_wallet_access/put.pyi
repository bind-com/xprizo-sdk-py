...
# Query params
SubAgentIdSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'subAgentId': typing.Union[SubAgentIdSchema, decimal.Decimal, int, ],
...
request_query_sub_agent_id = api_client.QueryParameter(
    name="subAgentId",
    style=api_client.ParameterStyle.FORM,
    schema=SubAgentIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyTextPlain = RelationshipModel
SchemaFor200ResponseBodyApplicationJson = RelationshipModel
SchemaFor200ResponseBodyTextJson = RelationshipModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_agent_set_wallet_access_put_oapg(
        self,
...
class ApiAgentSetWalletAccessPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_agent_set_wallet_access_put(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_agent_set_wallet_access_put(
        ...
        return self._api_agent_set_wallet_access_put_oapg(
