...
SchemaFor200ResponseBodyTextPlain = WalletModel
SchemaFor200ResponseBodyApplicationJson = WalletModel
SchemaFor200ResponseBodyTextJson = WalletModel
...
class ApiWalletInfoGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_wallet_info_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_wallet_info_get(
        ...
        return self._api_wallet_info_get_oapg(
