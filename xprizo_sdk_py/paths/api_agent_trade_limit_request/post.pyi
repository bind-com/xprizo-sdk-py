...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_agent_trade_limit_request_post_oapg(
        self,
...
class ApiAgentTradeLimitRequestPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_agent_trade_limit_request_post(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_agent_trade_limit_request_post(
        ...
        return self._api_agent_trade_limit_request_post_oapg(
