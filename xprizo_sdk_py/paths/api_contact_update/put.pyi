...
# body param
SchemaForRequestBodyApplicationJson = ContactModel
SchemaForRequestBodyTextJson = ContactModel
SchemaForRequestBodyApplicationJson = ContactModel


request_body_contact_model = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = ContactModel
SchemaFor200ResponseBodyApplicationJson = ContactModel
SchemaFor200ResponseBodyTextJson = ContactModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_contact_update_put_oapg(
        self,
    ...
    def _api_contact_update_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_contact_model.serialize(body, content_type)
...
class ApiContactUpdatePut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_contact_update_put(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_contact_update_put(
        ...
        return self._api_contact_update_put_oapg(
            body=body,
