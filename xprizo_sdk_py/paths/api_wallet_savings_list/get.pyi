...
class SchemaFor200ResponseBodyTextPlain(
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['WalletAccountModel'], typing.List['WalletAccountModel']],
    ...
    def __getitem__(self, i: int) -> 'WalletAccountModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_wallet_savings_list_get_oapg(
        self,
...
class ApiWalletSavingsListGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_wallet_savings_list_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_wallet_savings_list_get(
        ...
        return self._api_wallet_savings_list_get_oapg(
