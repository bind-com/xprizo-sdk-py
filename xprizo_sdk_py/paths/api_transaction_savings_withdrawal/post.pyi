...
# body param
SchemaForRequestBodyApplicationJson = UserSavingsWithdrawalTransactionModel
SchemaForRequestBodyTextJson = UserSavingsWithdrawalTransactionModel
SchemaForRequestBodyApplicationJson = UserSavingsWithdrawalTransactionModel


request_body_user_savings_withdrawal_transaction_model = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = ApprovalModel
SchemaFor200ResponseBodyApplicationJson = ApprovalModel
SchemaFor200ResponseBodyTextJson = ApprovalModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_transaction_savings_withdrawal_post_oapg(
        self,
    ...
    def _api_transaction_savings_withdrawal_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_user_savings_withdrawal_transaction_model.serialize(body, content_type)
...
class ApiTransactionSavingsWithdrawalPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_transaction_savings_withdrawal_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_transaction_savings_withdrawal_post(
        ...
        return self._api_transaction_savings_withdrawal_post_oapg(
            body=body,
