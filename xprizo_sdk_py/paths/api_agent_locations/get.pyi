...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ProfileAgentLocationModel']:
            return ProfileAgentLocationModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ProfileAgentLocationModel'], typing.List['ProfileAgentLocationModel']],
    ...
    def __getitem__(self, i: int) -> 'ProfileAgentLocationModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_agent_locations_get_oapg(
        self,
...
class ApiAgentLocationsGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_agent_locations_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_agent_locations_get(
        ...
        return self._api_agent_locations_get_oapg(
