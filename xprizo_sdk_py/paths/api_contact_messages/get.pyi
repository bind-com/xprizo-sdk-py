...
IncludeTransactionsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'includeTransactions': typing.Union[IncludeTransactionsSchema, bool, ],
...
request_query_include_transactions = api_client.QueryParameter(
    name="includeTransactions",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeTransactionsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyTextPlain = MessagePageModel
SchemaFor200ResponseBodyApplicationJson = MessagePageModel
SchemaFor200ResponseBodyTextJson = MessagePageModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_contact_messages_get_oapg(
        self,
    ...
    def _api_contact_messages_get_oapg(
        ...
        for parameter in (
            ...
            request_query_include_transactions,
            request_query__from,
        ):
...
class ApiContactMessagesGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_contact_messages_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_contact_messages_get(
        ...
        return self._api_contact_messages_get_oapg(
