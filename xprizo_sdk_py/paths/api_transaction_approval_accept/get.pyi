...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'once': typing.Union[OnceSchema, bool, ],
    },
    total=False
)
...
request_query_once = api_client.QueryParameter(
    name="once",
    style=api_client.ParameterStyle.FORM,
    schema=OnceSchema,
    explode=True,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_transaction_approval_accept_get_oapg(
        self,
...
class ApiTransactionApprovalAcceptGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_transaction_approval_accept_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_transaction_approval_accept_get(
        ...
        return self._api_transaction_approval_accept_get_oapg(
