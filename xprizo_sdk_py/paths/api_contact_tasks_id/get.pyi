...
class SchemaFor200ResponseBodyTextPlain(
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['TaskModel'], typing.List['TaskModel']],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_contact_tasks_id_get_oapg(
        self,
...
class ApiContactTasksIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_contact_tasks_id_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_contact_tasks_id_get(
        ...
        return self._api_contact_tasks_id_get_oapg(
