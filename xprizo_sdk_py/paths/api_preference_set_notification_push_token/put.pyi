...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_preference_set_notification_push_token_put_oapg(
        self,
...
class ApiPreferenceSetNotificationPushTokenPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_preference_set_notification_push_token_put(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_preference_set_notification_push_token_put(
        ...
        return self._api_preference_set_notification_push_token_put_oapg(
