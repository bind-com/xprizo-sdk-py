...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_contact_messages_set_read_put_oapg(
        self,
...
class ApiContactMessagesSetReadPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_contact_messages_set_read_put(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_contact_messages_set_read_put(
        ...
        return self._api_contact_messages_set_read_put_oapg(
