...
# Query params
OtpTypeSchema = OTPType
OtpSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'otpType': typing.Union[OtpTypeSchema, ],
        'otp': typing.Union[OtpSchema, str, ],
...
request_query_otp_type = api_client.QueryParameter(
    name="otpType",
    style=api_client.ParameterStyle.FORM,
    schema=OtpTypeSchema,
    explode=True,
)
request_query_otp = api_client.QueryParameter(
    name="otp",
    style=api_client.ParameterStyle.FORM,
    schema=OtpSchema,
    explode=True,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_profile_unlock_put_oapg(
        self,
...
class ApiProfileUnlockPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_profile_unlock_put(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_profile_unlock_put(
        ...
        return self._api_profile_unlock_put_oapg(
