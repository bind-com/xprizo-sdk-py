...
ValueSchema = schemas.Float64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'value': typing.Union[ValueSchema, decimal.Decimal, int, float, ],
    },
    total=False
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_agent_set_sub_agent_commission_put_oapg(
        self,
...
class ApiAgentSetSubAgentCommissionPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_agent_set_sub_agent_commission_put(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_agent_set_sub_agent_commission_put(
        ...
        return self._api_agent_set_sub_agent_commission_put_oapg(
