...
RecipientIdSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'recipientId': typing.Union[RecipientIdSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_recipient_id = api_client.QueryParameter(
    name="recipientId",
    style=api_client.ParameterStyle.FORM,
    schema=RecipientIdSchema,
    explode=True,
)
SchemaFor200ResponseBodyTextPlain = MessageModel
SchemaFor200ResponseBodyApplicationJson = MessageModel
SchemaFor200ResponseBodyTextJson = MessageModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_contact_send_message_post_oapg(
        self,
...
class ApiContactSendMessagePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_contact_send_message_post(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_contact_send_message_post(
        ...
        return self._api_contact_send_message_post_oapg(
