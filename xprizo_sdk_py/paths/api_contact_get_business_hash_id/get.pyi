...
request_path_hash_id = api_client.PathParameter(
    name="hashId",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_contact_get_business_hash_id_get_oapg(
        self,
...
class ApiContactGetBusinessHashIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_contact_get_business_hash_id_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_contact_get_business_hash_id_get(
        ...
        return self._api_contact_get_business_hash_id_get_oapg(
