...
CancelSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'cancel': typing.Union[CancelSchema, bool, ],
    },
    total=False
)
...
request_query_cancel = api_client.QueryParameter(
    name="cancel",
    style=api_client.ParameterStyle.FORM,
    schema=CancelSchema,
    explode=True,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_agent_reference_request_put_oapg(
        self,
...
class ApiAgentReferenceRequestPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_agent_reference_request_put(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_agent_reference_request_put(
        ...
        return self._api_agent_reference_request_put_oapg(
