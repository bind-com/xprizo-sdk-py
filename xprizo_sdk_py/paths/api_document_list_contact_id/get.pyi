...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ActivityKycModel']:
            return ActivityKycModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ActivityKycModel'], typing.List['ActivityKycModel']],
    ...
    def __getitem__(self, i: int) -> 'ActivityKycModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_document_list_contact_id_get_oapg(
        self,
...
class ApiDocumentListContactIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_document_list_contact_id_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_document_list_contact_id_get(
        ...
        return self._api_document_list_contact_id_get_oapg(
