...
SchemaFor200ResponseBodyTextPlain = PreferenceModel
SchemaFor200ResponseBodyApplicationJson = PreferenceModel
SchemaFor200ResponseBodyTextJson = PreferenceModel
...
class ApiPreferenceGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_preference_get(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_preference_get(
        ...
        return self._api_preference_get_oapg(
