...
# Query params
AgentIdSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'agentId': typing.Union[AgentIdSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_agent_add_sub_agent_request_post_oapg(
        self,
...
class ApiAgentAddSubAgentRequestPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_agent_add_sub_agent_request_post(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_agent_add_sub_agent_request_post(
        ...
        return self._api_agent_add_sub_agent_request_post_oapg(
