...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SubscriptionModel']:
            return SubscriptionModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SubscriptionModel'], typing.List['SubscriptionModel']],
    ...
    def __getitem__(self, i: int) -> 'SubscriptionModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_item_subscriptions_put_oapg(
        self,
...
class ApiItemSubscriptionsPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_item_subscriptions_put(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def api_item_subscriptions_put(
        ...
        return self._api_item_subscriptions_put_oapg(
