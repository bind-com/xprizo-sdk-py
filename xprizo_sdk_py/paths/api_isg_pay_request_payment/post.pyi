...
RedirectSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'redirect': typing.Union[RedirectSchema, str, ],
    },
    total=False
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_isg_pay_request_payment_post_oapg(
        self,
...
class ApiIsgPayRequestPaymentPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_isg_pay_request_payment_post(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_isg_pay_request_payment_post(
        ...
        return self._api_isg_pay_request_payment_post_oapg(
