...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_preference_set_allow_marketing_emails_put_oapg(
        self,
...
class ApiPreferenceSetAllowMarketingEmailsPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_preference_set_allow_marketing_emails_put(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_preference_set_allow_marketing_emails_put(
        ...
        return self._api_preference_set_allow_marketing_emails_put_oapg(
