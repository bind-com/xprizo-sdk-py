...
SavingsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'savings': typing.Union[SavingsSchema, bool, ],
    },
    total=False
)
...
request_query_savings = api_client.QueryParameter(
    name="savings",
    style=api_client.ParameterStyle.FORM,
    schema=SavingsSchema,
    explode=True,
)
SchemaFor200ResponseBodyTextPlain = WalletAccountModel
SchemaFor200ResponseBodyApplicationJson = WalletAccountModel
SchemaFor200ResponseBodyTextJson = WalletAccountModel
...
class ApiWalletAddPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_wallet_add_post(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_wallet_add_post(
        ...
        return self._api_wallet_add_post_oapg(
