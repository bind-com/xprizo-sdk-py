...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_security_apple_login_post_oapg(
        self,
...
class ApiSecurityAppleLoginPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_security_apple_login_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, str, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_security_apple_login_post(
        ...
        return self._api_security_apple_login_post_oapg(
            body=body,
