...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TransactionSummaryModel']:
            return TransactionSummaryModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['TransactionSummaryModel'], typing.List['TransactionSummaryModel']],
    ...
    def __getitem__(self, i: int) -> 'TransactionSummaryModel':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_wallet_transaction_summary_get_oapg(
        self,
...
class ApiWalletTransactionSummaryGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_wallet_transaction_summary_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_wallet_transaction_summary_get(
        ...
        return self._api_wallet_transaction_summary_get_oapg(
