...
SchemaFor200ResponseBodyTextPlain = TranHeadUserModel
SchemaFor200ResponseBodyApplicationJson = TranHeadUserModel
SchemaFor200ResponseBodyTextJson = TranHeadUserModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_merchant_get_data_get_oapg(
        self,
...
class ApiMerchantGetDataGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_merchant_get_data_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_merchant_get_data_get(
        ...
        return self._api_merchant_get_data_get_oapg(
