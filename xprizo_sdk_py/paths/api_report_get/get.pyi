...
SchemaFor200ResponseBodyTextPlain = ReportModel
SchemaFor200ResponseBodyApplicationJson = ReportModel
SchemaFor200ResponseBodyTextJson = ReportModel
...
class ApiReportGetGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_report_get_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_report_get_get(
        ...
        return self._api_report_get_get_oapg(
