...
# Path params
TransactionIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'transactionId': typing.Union[TransactionIdSchema, decimal.Decimal, int, ],
    }
)
...
SchemaFor200ResponseBodyTextPlain = WalletTranModel
SchemaFor200ResponseBodyApplicationJson = WalletTranModel
SchemaFor200ResponseBodyTextJson = WalletTranModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_wallet_transaction_transaction_id_get_oapg(
        self,
...
class ApiWalletTransactionTransactionIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_wallet_transaction_transaction_id_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_wallet_transaction_transaction_id_get(
        ...
        return self._api_wallet_transaction_transaction_id_get_oapg(
