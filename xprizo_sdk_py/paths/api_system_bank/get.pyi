...
SchemaFor200ResponseBodyTextPlain = LedgerBankingModel
SchemaFor200ResponseBodyApplicationJson = LedgerBankingModel
SchemaFor200ResponseBodyTextJson = LedgerBankingModel
...
class ApiSystemBankGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_system_bank_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_system_bank_get(
        ...
        return self._api_system_bank_get_oapg(
